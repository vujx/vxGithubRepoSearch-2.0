...
class SearchRepository(private val dataSource: SearchRepoDataSource) {
    ...
    suspend fun getSearchReposByStars() = dataSource.getSearchReposByStars()

    suspend fun getSearchReposByForks() = dataSource.getSearchReposByForks()

    suspend fun getSearchReposByDateUpdate() = dataSource.getSearchReposByDateUpdate()
}
